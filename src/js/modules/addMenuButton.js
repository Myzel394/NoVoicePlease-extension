    ...
    `;
        ...
        const observer = new MutationObserver(() => {
            if ($button.querySelector("slot") === null) {
                ...
                const $buttonContainer = $button.querySelector("yt-icon-button > button");
                const $titleContainer = $button.querySelector("yt-formatted-string");
                const $tooltipContainer = $button.querySelector(".tp-yt-paper-tooltip");
